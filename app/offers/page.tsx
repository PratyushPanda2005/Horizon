...
const OffersPage = () => {
    return (
        <main>
            <section className='relative px-8 pt-16 font-gilroy-medium'>
                <div className='max-w-7xl mx-auto relative'>
                    ...
                    <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full text-center text-white'>
                        <h1 className='text-7xl uppercase font-gilroy-bold'>
                            Offers
                        </h1>
                        <h2 className='text-lg font-gilroy-semibold'>
                            Travel More, Spend Less
                        </h2>
                    </div>
                </div>
                <div className='max-w-7xl mx-auto pt-10'>
                    <p className='text-base font-gilroy-medium text-center'>Refer your friends to join Phoenix Fly and both enjoy exclusive rewards. Discover new destinations, create unforgettable memories, and start referring today!</p>
                </div>
            </section>
            <HowItWorks />
            <HeroSlider
