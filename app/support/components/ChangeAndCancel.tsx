    ...
    return (
        <div className="flex-1 max-w-3xl">
            ...
            <div className="bg-white border border-gray-100 rounded-lg p-[30px] mb-12">
                <h3 className="text-center text-lg tracking-[-0.04em] font-gilroy-medium text-[#16242A] mb-8">Cancellation Charges</h3>
                ...
                <h3 className="text-center text-lg tracking-[-0.04em] font-gilroy-medium text-[#16242A] mb-8">Date Change Charges</h3>
                <ChargeRow label="Before 30 days" value="0%-5% of Total Amount" />
                <ChargeRow label="30-15 days" value="0%-50% of Total Amount" />
                <ChargeRow label="14-0 days" value="50%-100% of Total Amount" />
            ...
            <div className="space-y-4 text-lg tracking-[-0.02em] font-gilroy-medium text-[#16242A] leading-[28px]">
                <div className="flex gap-3">
                    <div className="mt-2 w-1 h-1 rounded-full bg-black shrink-0" />
                ...
                <div className="pt-8 text-lg tracking-[-0.02em] font-gilroy-medium text-[#16242A] leading-[28px]">
